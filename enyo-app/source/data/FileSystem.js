...
enyo.kind({
	...
	getNotesContent: function() {
		return [
			...
			"---------------------------",
			"",
			"3/5 - Found something big. Corp records",
			"      that don't add up. Need to dig more.",
			"",
			"3/7 - They're covering something up.",
			"      Project GIBSON keeps coming up.",
			"      What are they hiding?",
			"",
			"3/9 - Made contact with someone on the",
			"      underground BBS. Handle: Acid Burn.",
			"      Skeptical of me. Says I need to",
			"      prove myself. 'Mess with the best,",
			"      die like the rest' - their words.",
			"",
			"3/10 - Too dangerous to keep digging alone.",
	...
	getSystemLogContent: function() {
		return [
			...
			"03/14 02:15 - Login attempt from unknown",
			"03/14 02:16 - ALERT: Brute force detected",
			"03/14 02:20 - Connection terminated",
			"03/14 03:45 - Scheduled backup started",
			"03/14 03:47 - Backup complete",
			"03/14 08:00 - System startup",
			"03/14 08:01 - Hidden folder access: /secrets",
			"03/14 08:05 - File modified: too_many_secrets.enc",
			"03/14 08:30 - External connection: BBS dial-out",
			"03/14 08:35 - Connection closed",
			"",
	...
	getConnectionLogContent: function() {
		return [
			...
			"",
			"03/13 21:00 - The Underground (555-0199)",
			"              Duration: 47 minutes",
			"              Messages: 12 sent, 8 received",
			"",
			"03/11 19:30 - CyberDen BBS (555-0134)",
			"              Duration: 15 minutes",
			"              Status: Banned (reason unknown)",
			"",
			"03/09 22:15 - The Underground (555-0199)",
			"              Duration: 2 hours 13 minutes",
			"              First contact with Acid Burn",
			"",
	...
	getFragmentContent: function() {
		return [
			...
			"...what do hackers do? They hack...",
			"...the password is just 'hackers'...",
			"...Acid Burn said to memorize it...",
	...
	getBBSListContent: function() {
		return [
			...
			"--------------------------",
			"",
			"The Underground     555-0199  [ACTIVE]",
			"  - Password required",
			"  - Home of Acid Burn",
			"  - \"Boot Up or Shut Up!\"",
			"",
			"CyberDen           555-0134  [BANNED]",
			"  - Too many narcs",
			"",
			"PhreakHole         555-0177  [DEAD]",
			"  - Shut down by feds 03/01",
			"",
			"The Gibson Files   555-0200  [UNKNOWN]",
			"  - Rumored to exist",
			"  - No confirmed access",
			"",
			"To connect: Use Network Tool",
			"            Dial number + password",
			""
		].join("\n");
	},
