...
//App Details
$description = "Use your retro-computing skills to connect with the elite Hacker Underground and uncover a conspiracy that spans cyberspace!";
$title = "Hacker Mystery 95";
...
?>
  ...
  <div id="row">
    <div id="content" align="left">
      ...
      <p>Available for tablet and PC platforms as a Progressive Web App, and the webOS App Museum for webOS devices.</p>
  ...
  <div id="footer">
    &copy; codepoet and webOS Archive
    <div id="footer-links">
